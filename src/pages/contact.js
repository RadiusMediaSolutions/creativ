	...
	<Layout>
		...
		<section>
			<ContactSection className="mColumn">
				...
				<div className="box">
					<FaRegEnvelope className="cnt-icon" />
				...
				<div className="box">
					<FaMapMarkerAlt className="cnt-icon" />
			...
			<CntForm>
				...
				<GenericPara lessSize>
					Please fill out the contact form below so we know what types
					of interest you have!. We want to make sure that our clients
					are well informed about their options before they commit. So
					please take 2 minutes of your day for us by filling out this
					one simple form–we’ll be emailing back within 24 hours with
